...
suite('GscDiagnosticsCollection.CoD2MP', () => {
    ...
    test('GscDiagnosticsCollection.CoD2MP.functionParameters', async () => {
        ...
        tests.checkDiagnostic(diagnostics, 2, "Function 'spawn' expect min 2 parameters, got 0", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 3, "Function 'spawn' expect min 2 parameters, got 0", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 4, "Function 'aCos' can not be called on object (does not support callon object)", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 5, "Function 'getAmmoCount' must be called on object (callon object is missing)", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 6, "Function 'spawn' expect min 2 parameters, got 0", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 7, "Function 'spawn' expect min 2 parameters, got 1", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 8, "Function 'spawn' expect max 5 parameters, got 6", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 9, "Function 'spawn' expect max 5 parameters, got 7", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 10, "Function 'spawn' expect max 5 parameters, got 8", vscode.DiagnosticSeverity.Error);
    ...
    test('GscDiagnosticsCollection.CoD2MP.functionParametersLocal', async () => {
        ...
        tests.checkDiagnostic(diagnostics, 2, "Function 'p1' expect 1 parameter, got 2", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 3, "Function 'p2' expect 2 parameters, got 3", vscode.DiagnosticSeverity.Error);
        tests.checkDiagnostic(diagnostics, 4, "Function 'p2' expect 2 parameters, got 5", vscode.DiagnosticSeverity.Error);
