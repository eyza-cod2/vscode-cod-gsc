...
suite('GscFileParser.parse #2.13 for', () => {
    ...
    test(`#2.13.6 for`, async () => {
        ...
        checkGroup2(rootGroup, rootGroup.items[0].items[0].items[1].items[1].items[0], GroupType.Expression, 6, 7, false, 0);
    ...
    test(`#2.13.9 for error 2`, async () => {
        ...
        checkGroup2(rootGroup, rootGroup.items[0].items[1].items[0].items[0].items[1].items[1].items[0], GroupType.Expression, 16, 17, false, 0);
...
suite('GscFileParser.parse #2.16 terminators', () => {
    ...
    test(`#2.16.2 as statement`, async () => {
        ...
        checkGroup2(rootGroup, rootGroup.items[0].items[1].items[1], GroupType.ExtraTerminator, 9, 9, true, 0);
    });
...
suite("GscFileParser.GscGroup #2.20", () => {
